        ...
        <el-table
          ...
          <el-table-column
           ...
           <el-table-column
            ...
            <el-table-column
            prop="collection_viewCount"
            label="加入播单"
            sortable
            width="180">
          </el-table-column>
            <el-table-column
            prop="download_viewCount"
            label="下载量"
            width="180">
          </el-table-column>
            <el-table-column
  ...
  //  el:'.check',
   data() {
    ...
    methods: {
     ...
     timeChangeFunction () {
      var dataStar = this.value3[0];
      var dataEnd = this.value3[1];
      var startDate = dataStar.getFullYear() + '-'+(dataStar.getMonth() + 1) +'-' +dataStar.getDate() ;
      var endDate = dataEnd.getFullYear() + '-'+(dataEnd.getMonth() + 1)+'-' + dataEnd.getDate() ;
        console.log(dataStar.getFullYear() + '-'+(dataStar.getMonth() + 1) +'-' +dataStar.getDate());
        console.log(dataEnd.getFullYear() + '-'+(dataEnd.getMonth() + 1)+'-' + dataEnd.getDate());
        var apkVersion = '1.3.3';
        
        var systemName = 'IOS' ; 

          this.getDataList(startDate,endDate,systemName,apkVersion);
      ...
      getDataList(startDate,endDate,systemName,apkVersion){
        var _this = this ;
